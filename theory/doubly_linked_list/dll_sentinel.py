...
class DLLSentinel:
    ...
    def __init__(self, get_key_func=None):
        """
        Initialize the sentinel of a circular doubly linked list 
        with a sentinel.
    ...
    def search(self, k):
        """
        Search a circular doubly linked list with a sentinel 
    ...
    def insert(self, data, y):
        """
        Insert a node with data after node y.  
        Return the new node.
        """
    ...
    def prepend(self, data):
        """
        Insert a node with data as the head of a circular 
    ...
    def append(self, data):
        """
        Append a node with data to the tail of a 
    ...
    def delete(self, x):
        """
        Remove a node x from the a circular doubly 
    ...
    def delete_all(self):
        """
        Delete all nodes in a circular doubly linked 
        list with a sentinel.
        """
    ...
    def iterator(self):
        """
        Iterator from the head of a circular doubly 
        linked list with a sentinel.
        """
        x = self.sentinel.next
    ...
    def copy(self):
        """
        Return a copy of this circular doubly linked 
        list with a sentinel.
        """
    ...
    def __str__(self):
        """
        Return this circular doubly linked list with a 
        sentinel formatted as a list.
        """
        x = self.sentinel.next
        string = "["
        while x != self.sentinel:
