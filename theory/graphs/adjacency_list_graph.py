...
class Edge:
    def __init__(self, v, weight=None):
        """
        Initialize an edge to add to the adjacency list 
        of another vertex.
        """
        self.v = v
...
class AdjacencyListGraph:
    def __init__(self, card_V, directed=True, weighted=False):
        """
        Intialized a graph implemented by an adjacency list.
        Vertices are numbered from 0, so adj_list[i] corresponds
        to adjacency list of vertex i.
        ...
        self.adj_lists = [None] * card_V  # each element in the list will be a poiter to a doubly linked list
    ...
    def get_adj_lists(self):
        """
        Return the adjacency lists of all the vertices 
        in this graph.
        """
    ...
    def is_directed(self):
        """
        Return a boolean indicating whether this graph is 
        directed.
        """
    ...
    def insert_edge(self, u, v, weight=None):
        ...
        # If this graph is undirected, insert an edge from v to u -- opposite of what was done before (u - v)
    ...
    def find_edge(self, u, v):
        """
        Return the edge object for edge (u, v) if (u, v) is in this graph, 
        None otherwise.
        """
    ...
    def delete_edge(self, u, v, delete_undirected=True):
        ...
        Delete both directions if the graph is undirected and 
        delete_undirected is True.
        """
        edge = self.adj_lists[u].search(v)
        if edge is not None:
